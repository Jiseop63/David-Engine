...
namespace da
{
	...
	void PlayScene::InitBGObj()
	{
		...
		// BGObj cloud
		{
			...
			// backGroundTr->SetPosition(math::Vector3(-4.0f, 1.0f, -1.0f));
		}
		// BGObj cloud
		{
		...
		// BGObj cloud
		{
			...
			// backGroundTr->SetPosition(math::Vector3(3.0f, 1.0f, -1.0f));
		}
		...
		// BGObj cloud
		{
			...
			// backGroundTr->SetPosition(math::Vector3(2.50f, -2.0f, -1.0f));
		}
		...
		// BGObj titleLogo
		{
			...
			// backGroundTr->SetPosition(math::Vector3(0.0f, 2.0f, -1.10f));
		}
