...
namespace da
{
	...
	void SkellBossProjectileScript::Initialize()
	{
		...
		mActionUnitAnimator->Create(L"SkellBossLaser", Resources::Find<Texture>(L"SkellBossLaser"), math::Vector2::Zero, math::Vector2(384.0f, 55.0f), 7, math::Vector2::Zero, 0.10f, 400.0f);
